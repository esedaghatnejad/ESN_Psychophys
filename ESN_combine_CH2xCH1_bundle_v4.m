...
save_file_name = EPHYS.file_name_base;
save_file_path = uigetdir(EPHYS.CH_1_sorted_file_path, 'Select where to save the figures.');
fprintf(['Saving ' save_file_name ' ... ']);
if ~isequal(save_file_path,0)
save_file_path = [save_file_path filesep];
saveas(fig_handle_(1),[save_file_path save_file_name '_SSxSS'], 'pdf');
saveas(fig_handle_(1),[save_file_path save_file_name '_SSxSS'], 'png');
saveas(fig_handle_(2),[save_file_path save_file_name '_CSxSS'], 'pdf');
saveas(fig_handle_(2),[save_file_path save_file_name '_CSxSS'], 'png');
saveas(fig_handle_(3),[save_file_path save_file_name '_CSxCS'], 'pdf');
saveas(fig_handle_(3),[save_file_path save_file_name '_CSxCS'], 'png');
close(fig_handle_(1))
close(fig_handle_(2))
close(fig_handle_(3))
end
...
[save_file_name,save_file_path] = uiputfile([EPHYS.CH_1_sorted_file_path file_name '.mat'], 'Select where to save the plot data.');
fprintf(['Saving ' save_file_name ' ... ']);
if ~isequal(save_file_path,0)
...
save([save_file_path save_file_name], 'CH_1','CH_2','-v7.3');
end
fprintf(' --> Completed. \n');
end
