...
%% Build CH_sorted
EPHYS.CH_sorted.CH_data = EPHYS.CH_SS_sorted.CH_data;
EPHYS.CH_sorted.SS_data = EPHYS.CH_SS_sorted.SS_data;
EPHYS.CH_sorted.CS_data = EPHYS.CH_CS_sorted.CS_data;
EPHYS.CH_sorted.CS_data.CS_waveform = EPHYS.CH_sorted.CH_data.CH_hipass(EPHYS.CH_sorted.CS_data.CS_inds);
