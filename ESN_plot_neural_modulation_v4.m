...
plot(x_axis_SS_(:), y_axis_SS_(:), 'LineWidth', 1, 'Color', Line_Color(1,:))
[x_axis_CS_, y_axis_CS_] = ESN_raster_plot_axes(train_data_logic_CS_, inds_span, 2);
plot(x_axis_CS_(:), y_axis_CS_(:), 'LineWidth', 2, 'Color', Line_Color(2,:))
...
plot(inds_span, ESN_smooth(firing_SS_), 'LineWidth', 2, 'Color', Line_Color(7,:))
...
plot(x_axis(:), y_axis(:), 'LineWidth', 3, 'Color', Line_Color(7,:))
axis equal
set(gca, 'YColor', Line_Color(7,:))
set(gca, 'XColor', Line_Color(7,:))
