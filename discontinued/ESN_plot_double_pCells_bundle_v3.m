function ESN_plot_double_pCells_bundle_v3(num_data_set)
if nargin < 1
    num_data_set = 1;
end
%% Load dataset
...
for counter_date_set = 1 : num_data_set
    [file_name,file_path] = uigetfile([file_path filesep '*_CH*.mat'], 'Select Data set file');
...
file_name_base = [file_name_date '_CH' file_name_CH1 'x' 'CH' file_name_CH2 '_bundle'];
...
[save_file_name,save_file_path] = uiputfile([EPHYS.file_path filesep file_name '.mat'], 'Select where to save the _sorted mat-file.');
